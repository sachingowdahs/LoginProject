...
function AddDeveloperTrainee() {
  ...
  const data1 = {id : data?.length+1,Name : Name , Education : Education,Experience:Experience ,PassedYear:PassedYear,Skills:Skills, Cnumber:Cnumber,Email:Email}

  const Pusharray = () => {
    if(Name && Education && PassedYear && Skills && Cnumber && Email && Experience){
...
<div style={{height:"80vh"}}>
      ...
      <Modal show={show} onHide={handleClose}>
        <Modal.Header closeButton>
          <Modal.Title>Add Developer Trainee</Modal.Title>
        </Modal.Header>
      ...
      <input type="text" placeholder="Experience" className="textInputC" onChange={(e)=>{setExperience(e.target.value)}}/>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Add Developer Trainee</h1>
...
export default AddDeveloperTrainee;